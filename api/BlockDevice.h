...
#ifndef ARDUINO_BLOCK_DEVICE_H
#define ARDUINO_BLOCK_DEVICE_H
...
using arduino::BlockDevice;
using arduino::bd_addr_t;
using arduino::bd_size_t;
using arduino::BD_ERROR_OK;
using arduino::BD_ERROR_DEVICE_ERROR;
